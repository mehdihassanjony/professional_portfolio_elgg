...
if (elgg_is_xhr()) {  //This is an Ajax call!
    ...
    switch ($section) {
        case "profile":
            ...
            $error_message = elgg_echo('gcc_profile:error');
            ...
            foreach ( $profile_fields as $f => $v ) {
                ...
                if ($f === "email") {
                    ...
                    if (!$v) {
                        register_error($error_message.elgg_echo('gcc_profile:missingemail'));
                        return true;
                    }
                    ...
                    if ($v) {
                        ...
                        if (count($list_of_domains) > 0) {
                            ...
                            $error_message = $error_message.elgg_echo('gcc_profile:notaccepted');
                        }
        ...
        case 'old-skills':
            ...
            break;
        case 'languages':
            $bengali = get_input('bengali', 'ERROR: Ask your admin to grep: ASFDJKGJKG333616.');
